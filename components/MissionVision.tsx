      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-2 gap-12 mb-16">
          ...
          <div className="relative group h-full">
            <div className="absolute -inset-1 bg-gradient-to-r from-blue-600 to-blue-400 rounded-3xl opacity-10 group-hover:opacity-20 transition-opacity"></div>
          ...
          {/* Visión - Destacada */}
          <div className="relative group h-full">
            <div className="absolute -inset-1 bg-gradient-to-r from-blue-500 to-blue-300 rounded-3xl opacity-10 group-hover:opacity-20 transition-opacity"></div>
            <div className="relative bg-white p-8 md:p-10 rounded-3xl border-2 border-blue-100 shadow-lg hover:shadow-xl transition-all h-full flex flex-col">
              <div className="flex items-center gap-4 mb-6">
